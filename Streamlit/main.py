...
with tit2:
    selected = option_menu(
        ...
        icons=["grid-1x2-fill", "cash-coin"],
        menu_icon="cast",
        default_index=0,
        orientation="horizontal", )

if selected == 'Classification':
    st.header("Give the Details to Predict the Status of progress of orders or transactions")
    ...
    st.header("Give the Details to Predict the Price of the Copper")
    inp1, inp2 = st.columns(2)
    with inp1:
        st.markdown("###### Customer Id")
        i1 = st.text_input('i1', label_visibility="collapsed", placeholder="Enter 8 digit Customer id")
